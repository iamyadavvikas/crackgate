...
function genNumerical(rand: () => number, startId: number): Q[] {
  ...
  const gens = [...NUM_GENERATORS];
  // Shuffle generator order per set so topic sequence varies.
  ...
  while (out.length < 25) {
    ...
    gi++;
    const spec = g(rand);
    if (seen.has(spec.stem)) continue; // avoid identical stems within a set
    seen.add(spec.stem);
...
// Real dated June-2026 headlines (same set verified for Set 1). Each solution
// is tagged "(Verify before publish.)" — these must be primary-source checked
// before the mocks are made public.
const CURRENT_AFFAIRS: FactQ[] = [
  { topic: "Current Affairs · Economy", difficulty: "medium", stem: "As per Income Tax Department data (June 2026), India's net direct tax collections in early FY27 rose by about what percentage year-on-year?", correct: "14.6%", distractors: ["8.4%", "22.1%", "5.2%"], solution: "Net direct tax collections rose ~14.6% YoY to about Rs 5.21 trillion. (Verify before publish.)" },
  { topic: "Current Affairs · International", difficulty: "medium", stem: "In 2026, which country became the first Central Asian member of the New Development Bank (NDB)?", correct: "Uzbekistan", distractors: ["Kazakhstan", "Tajikistan", "Turkmenistan"], solution: "Uzbekistan became the first Central Asian nation to join the BRICS-backed NDB. (Verify before publish.)" },
  { topic: "Current Affairs · Awards", difficulty: "medium", stem: "Which India-born theoretical physicist won the 2025 Wolf Prize in Physics?", correct: "Jainendra K. Jain", distractors: ["Ashoke Sen", "Abhay Ashtekar", "C. V. Vishveshwara"], solution: "Rajasthan-born physicist Jainendra K. Jain received the 2025 Wolf Prize in Physics. (Verify before publish.)" },
  { topic: "Current Affairs · Reports", difficulty: "easy", stem: "Which institution ranked first in the QS World University Rankings 2027 (released June 2026)?", correct: "MIT", distractors: ["Stanford University", "University of Oxford", "Harvard University"], solution: "Massachusetts Institute of Technology (MIT) ranked first in QS World University Rankings 2027. (Verify before publish.)" },
  { topic: "Current Affairs · International", difficulty: "hard", stem: "In June 2026, which Indian jurist was elected a Judge of the International Tribunal for the Law of the Sea (ITLOS)?", correct: "Bimal N. Patel", distractors: ["Dalveer Bhandari", "Nagendra Singh", "R. S. Pathak"], solution: "Indian jurist Bimal N. Patel was elected to ITLOS in June 2026. (Verify before publish.)" },
  { topic: "Current Affairs · Awards", difficulty: "medium", stem: "In 2026, PM Narendra Modi received the highest national award of which country?", correct: "Slovakia", distractors: ["Cyprus", "Egypt", "Fiji"], solution: "PM Modi was conferred Slovakia's highest national award in 2026. (Verify before publish.)" },
  { topic: "Current Affairs · Defence", difficulty: "medium", stem: "Exercise KHAAN QUEST 2026, in which an Indian Army contingent participated, was held in which country?", correct: "Mongolia", distractors: ["Nepal", "Kazakhstan", "Russia"], solution: "The multinational Exercise KHAAN QUEST 2026 was held in Mongolia. (Verify before publish.)" },
  { topic: "Current Affairs · Appointments", difficulty: "hard", stem: "Who was named the new Chairman of GIC Re in June 2026?", correct: "Hitesh Joshi", distractors: ["Devesh Srivastava", "N. Ramaswamy", "A. K. Roy"], solution: "The government named Hitesh Joshi as the new Chairman of GIC Re. (Verify before publish.)" },
  { topic: "Current Affairs · Economy", difficulty: "medium", stem: "In 2026, ONGC was assigned to develop a new strategic petroleum reserve (SPR) facility at which location?", correct: "Mangaluru", distractors: ["Padur", "Bikaner", "Chandikhol"], solution: "ONGC was tasked with building a new underground crude oil SPR cavern at Mangaluru, Karnataka. (Verify before publish.)" },
  { topic: "Current Affairs · International", difficulty: "medium", stem: "The India\\u2013UK CETA and Social Security Agreement were reported to take effect from which date?", correct: "July 15, 2026", distractors: ["January 1, 2027", "August 15, 2026", "April 1, 2026"], solution: "Reports indicated the India\\u2013UK CETA would take effect from July 15, 2026. (Verify before publish.)" },
];
...
const CIVIL_NUM_GENERATORS: CivGen[] = [
  ...
  (rand) => {
    return {
      ...
      correct: "\\u03b1E\\u0394T",
      distractors: ["\\u03b1\\u0394T", "E\\u0394T/\\u03b1", "\\u03b1E/\\u0394T"],
      solution: "Restrained thermal stress = \\u03b1E\\u0394T, independent of length and area.",
    };
  },
  ...
  (rand) => {
    ...
    return {
      ...
      solution: `Ka = (1\\u2212sin\\u03c6)/(1+sin\\u03c6) = ${r2(ka)} for \\u03c6 = ${phi}\\u00b0.`,
    };
  },
...
const CIVIL_THEORY_POOL: FactQ[] = [
  ...
  { topic: "Strength of Materials", difficulty: "medium", stem: "Torsional shear stress in a circular shaft is given by:", correct: "\\u03c4 = Tr/J", distractors: ["\\u03c3 = My/I", "\\u03c4 = VQ/Ib", "\\u03c3 = P/A"], solution: "The torsion formula is \\u03c4/r = T/J = G\\u03b8/L." },
  { topic: "Strength of Materials", difficulty: "hard", stem: "The strain energy stored per unit volume under axial stress \\u03c3 is:", correct: "\\u03c3\\u00b2/2E", distractors: ["\\u03c3\\u00b2E/2", "\\u03c3E\\u00b2", "2\\u03c3\\u00b2/E"], solution: "Resilience (strain energy density) = \\u03c3\\u00b2/2E." },
  // Structural Analysis
  ...
  { topic: "RCC Design", difficulty: "medium", stem: "The development length Ld of a bar is given by:", correct: "\\u03c6\\u03c3s / (4\\u03c4bd)", distractors: ["4\\u03c4bd / (\\u03c6\\u03c3s)", "\\u03c6 / \\u03c3s", "\\u03c3s / \\u03c6"], solution: "Ld = \\u03c6\\u03c3s/(4\\u03c4bd), where \\u03c6 is bar diameter and \\u03c4bd is design bond stress." },
  ...
  { topic: "RCC Design", difficulty: "medium", stem: "The modular ratio m in working stress design is taken as:", correct: "280/(3\\u03c3cbc)", distractors: ["\\u03c3cbc/280", "280\\u03c3cbc", "3\\u03c3cbc/280"], solution: "IS 456 gives the modular ratio as m = 280/(3\\u03c3cbc)." },
  ...
  { topic: "Geotechnical Engineering", difficulty: "hard", stem: "The shear strength of a cohesionless soil is governed by:", correct: "Internal friction angle", distractors: ["Cohesion only", "Plasticity index", "Liquid limit"], solution: "For sands, shear strength = \\u03c3' tan\\u03c6 (no cohesion)." },
  // Fluid Mechanics
...
function genProfessional(rand: () => number, startId: number, setNo: number): Q[] {
  const out: Q[] = [];
  // 60 theory questions: rotate the pool by set for a distinct slice.
  const theoryOffset = ((setNo - 1) * 60) % CIVIL_THEORY_POOL.length;
  const theorySlice: FactQ[] = [];
  const usedT = new Set<string>();
  for (let i = 0; theorySlice.length < 60; i++) {
    const f = CIVIL_THEORY_POOL[(theoryOffset + i) % CIVIL_THEORY_POOL.length];
    if (usedT.has(f.stem)) continue;
    usedT.add(f.stem);
    theorySlice.push(f);
  }
  // 40 numerical questions: cycle the parametric generators (numbers vary).
  const numItems: FactQ[] = [];
  const gens = [...CIVIL_NUM_GENERATORS];
  for (let i = gens.length - 1; i > 0; i--) {
    const j = Math.floor(rand() * (i + 1));
    [gens[i], gens[j]] = [gens[j], gens[i]];
  }
  ...
  let gi = 0;
  let guard = 0;
  while (numItems.length < 40 && guard < 2000) {
    guard++;
    const f = gens[gi % gens.length](rand);
    gi++;
    if (seenNum.has(f.stem)) continue;
    seenNum.add(f.stem);
    numItems.push(f);
  }
